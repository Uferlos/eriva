...
$query = "SELECT * FROM asignaturas WHERE id_semestre = '$id_s'";
...
if($result_a->num_rows): ?>
	...
	while($row = $result_a->fetch_assoc()):
		$query_c = "SELECT * FROM calificaciones WHERE ci_alumno = '$ci' and id_asignatura = '$row[id]'";
            ...
            <span class="select is-small">
              ...
              for($j=0; $j<=19; $j++):
				...
				<td>
					<p class="control">
  					<span class="select is-small">
							<select id="te" class="select is-small" name="te[<?php echo $x ?>]" style="margin-bottom:0px;width:60px;">
				...
				<td>
					<p class="control">
 						<span class="select is-small">
							<select class="select is-small" name="mes[<?php echo $x ?>]" style="margin-bottom:0px; width:60px;"><?php
							for($i=1; $i<=12; $i++):
				...
				<td>
					<input type="text" class="num-only input is-small id_plantel" name="id_plantel[<?php echo $x ?>]" style="width:60px; margin-bottom:0px;" value="<?php echo $row_c['id_plantel'] ?>" required>
				</td>
			<tr>
		<?php else : ?>
			<tr>
          ...
          <p class="control">
              <span class="select is-small">
				...
				<td>
					<p class="control">
 						<span class="select is-small">
							<select class="select is-small" id="te[<?php echo $x ?>]" name="te[<?php echo $x ?>]" style="margin-bottom:0px; width:60px;">
								<option value="F">F</option>
								<option value="R">R</option>
								<option value="X">X</option>
								<option value="P">P</option>
				...
				<td>
					<input type="text" class="num-only input is-small anio" name="anio[<?php echo $x ?>]" style="width:60px; margin-bottom:0px;" value="<?php echo $row_c['anio'] ?>" required>
				</td>
