...
$query_semestres = "SELECT * FROM semestresG order by id";
...
<span id="banner">
  ...
  <p id="fn-xs">
    ...
    <span id="fn-sm">
      <b>I. Plan de Estudio:</b>&nbsp;<u><?php echo $rowP['planestudioG'] ?></u><br>
      <b>Código del Plan de Estudio:</b>&nbsp;<u><?php echo $rowP['codigoG'] ?></u><br>
      <b>Mención:</b>&nbsp;<u><?php echo $rowP['mencionG'] ?></u>
    </span>
  </p>
</span>
<hr>
<span id="sBanner">
  ...
  <p id="fn-sm">
    ...
    <b>Teléfono:&nbsp;</b><?php if($rowD['telefono'] == ''){echo "______________";}else{echo "<u>".$rowD['telefono']."</u>";} ?>&nbsp;
...
<?php
  ...
  <div style="margin-top: 25px; display: inline-block; width: 47%;" class="bs-docs-example" title="<?php echo $row_semestres['semestre']?>"><?php
    $query_asignaturas = "SELECT * FROM asignaturasG WHERE id_semestre = '$row_semestres[id]'";
    ...
    <table class="tableN" border="1">
      <tr>
        ...
        <td colspan="2"><b>Calificación</b></td>
        <td><b>T-E</b></td>
        <td><b>Mes</b></td>
        <td><b>Año</b></td>
        <td><b>Plantel N°</b></td>
      ...
      <tr>
        ...
        $query_c = "SELECT * FROM calificacionesG WHERE ci_alumno = '$ci_a' AND id_asignatura = '$row_a[id]'";
