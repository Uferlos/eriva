...
$row = $res->fetch_assoc();
?>
<form id="formCalificacionesN" autocomplete="off">
  <div class="title">Calificaciones del Periodo: <?php echo $_POST['nombreSemestre'] ?> </div>
...
<br><br>
<button type="button" class="button is-white" id="closeEMN">Cerrar</button>
<button type="submit" form="formCalificacionesN" class="button is-info">Procesar Notas</button>
