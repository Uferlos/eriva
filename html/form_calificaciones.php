...
$row = $res->fetch_assoc();
?>
<form id="formCalificaciones" autocomplete="off">
...
<br><br>
<button type="button" class="button is-white" id="closeEM">Cerrar</button>
<button type="submit" form="formCalificaciones" class="button is-info">Procesar Notas</button>
